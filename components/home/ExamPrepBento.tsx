    ...
    <Section variant="sky">
      <Container>
        ...
        <div className="grid grid-cols-1 gap-8 md:grid-cols-3">
          {/* Featured Card — GRE */}
          <Reveal direction="left" delay={150} className="md:col-span-2 flex">
            <Card padding="lg" variant="primary" className="shadow-xl flex flex-col justify-between w-full">
              <div>
          ...
          <div className="flex flex-col gap-8">
            <Reveal direction="right" delay={250} className="flex-1">
            ...
            <Reveal direction="right" delay={350} className="flex-1">
